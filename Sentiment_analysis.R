...
library(dismo) ## to enable the location in searchtwitteR

##### Set API Keys (entering keys from the Twitter app)
api_key <- "zGn60BCUBLAIh4yvOUY3sAaiJ"
api_secret <- "RT5EXrhrt6h4v3bdcWBADaQoX8WZIiJcaThvafoz68xohxM66z"
access_token <- "752919766264901632-U3QNunFgAwRhje5YhAX83t4benQ0bvv"
access_token_secret <- "nzaGpEYAFQczA2q9KMVDHLrOZp84Qp9Ak60eaC0HbNwFu"
